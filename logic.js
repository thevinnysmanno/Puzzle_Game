...
function checkSolved() {
	...
	const checkSquares = [...document.querySelectorAll('div .square')];
	const check = (square) => square.id === square.style.order;
	
	return checkSquares.every(check);
}
